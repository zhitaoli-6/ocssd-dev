				   ...
				   unsigned long free_blocks)
{
    ...
    printk("pblk: free_blocks=%lu, rb_user_max=%d, rb_gc_max=%d\n", free_blocks, rl->rb_user_max, rl->rb_gc_max); //add by kan for debug
...
void pblk_rl_init(struct pblk_rl *rl, int budget)
{
    ...
    printk("pblk: rb_windows = %d rl->rb_windows_pw=%d\n", rb_windows, rl->rb_windows_pw); //add by kan for debug
